...
namespace ZoomLa.BLL.Design
{
    ...
    public class B_Design_Helper
    {
        ...
        public DataSet PackSiteToDS(int siteID)
        {
            ...
            nids = string.IsNullOrEmpty(nids) ? "0" : nids;
        ...
        //-----------------------------用户块
        static string _ss = "";
        public static string H5_AccessPwd { get { return _ss; } set { _ss = value; } }
        ...
        public static void CheckIsClose()
        {
            if (SiteConfig.SiteOption.DesignIsClose) { function.WriteErrMsg("尚未开启动力模块功能"); }
        }
    }
}
