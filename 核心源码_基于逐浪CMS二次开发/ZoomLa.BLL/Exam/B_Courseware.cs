...
namespace ZoomLa.BLL
{
    ...
    public class B_Courseware
    {
        ...
        private static M_Courseware GetInfoFromReader(DbDataReader rdr)
        {
        ...
        public PageSetting SelPage(int cpage, int psize, int CourseID = -100)
        {
            string where = " 1=1";
            if (CourseID != -100) { where += " AND CouresID=" + CourseID; }
