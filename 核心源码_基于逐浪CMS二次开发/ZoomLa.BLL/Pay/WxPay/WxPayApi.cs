...
namespace ZoomLa.BLL.WxPayAPI
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 10)
        {
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 20)
        {
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 20)
        {
            ...
            string xml = inputObj.ToXml();
            //var start = DateTime.Now;
            string response = HttpService.Post(xml, url, true, timeOut,appMod);//调用HTTP通信接口提交数据到API
            //var end = DateTime.Now;
            //int timeCost = (int)((end - start).TotalMilliseconds);//获得接口耗时
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData RefundQuery(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 20)
        {
	    ...
	    */
        private static void ReportCostTime(string interface_url, int timeCost, WxPayData inputObj, M_WX_APPID appMod)
        {
	    ...
	    */
        public static WxPayData Report(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 1)
        {
        ...
        * 根据当前系统时间加随机序列来生成订单号
         * @return 订单号
        */
        public static string GenerateOutTradeNo(M_WX_APPID appMod)
        {
            var ran = new Random();
            return string.Format("{0}{1}{2}", appMod.Pay_AccountID, DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999));
        }
        /**
        ...
        */
        ...
        /// </summary>
        /// <returns></returns>
        public static WxPayData Pay_Transfer(WxPayData wxdata, M_WX_APPID appMod)
        {
            string url = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";
            //wxdata.SetValue("partner_trade_no", B_OrderList.CreateOrderNo(M_OrderList.OrderEnum.Cloud));
            //wxdata.SetValue("openid", "oaLxyt7ZTVnjPmqkTI-SY-Z9akzw");
            //wxdata.SetValue("check_name", "OPTION_CHECK");
            //wxdata.SetValue("re_user_name", "徐林之");
            //wxdata.SetValue("amount", "100");
            //wxdata.SetValue("desc", "提现");
            //wxdata.SetValue("spbill_create_ip", "58.215.65.54");

            wxdata.SetValue("mch_appid", appMod.Pay_APPID);//公众帐号ID
            wxdata.SetValue("mchid", appMod.Pay_AccountID);//商户号
            wxdata.SetValue("nonce_str", WxAPI.nonce);//随机字符串，Guid.NewGuid().ToString().Replace("-", "")
            wxdata.SetValue("sign", wxdata.MakeSign());//签名
        ...
        public static M_WX_APPID Pay_GetByID(int appid = 0)
        {
            ...
            if (appid > 0) { appMod = WxAPI.Code_Get(appid).AppId; }
            else
            {
