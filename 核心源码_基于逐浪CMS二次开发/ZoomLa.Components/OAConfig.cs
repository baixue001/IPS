...
namespace ZoomLa.Components
{
    ...
    {
        private static string filePath { get { return function.VToP("/Config/OA.config"); } }
        ...
        public static string SignPath
        {
            get
            {
                string _path= GetInstance().SignPath;
                if (string.IsNullOrEmpty(_path)) { _path = "/UploadFiles/OA/OASign/"; }
                return _path;
            }
            set
            {
