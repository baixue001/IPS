    ...
    public class M_CollectionItem:M_Base
    {
        ...
        public override string[,] FieldList()
        {
            string[,] Tablelist = {
                                  ...
                                  {"ListSettings","NText","50000"}, 
                                  {"PageSettings","NText","50000"}, 
                                  {"InfoPageSettings","NText","50000"}, 
                                  {"AddTime","DateTime","8"}, 
                                  {"LastTime","NVarChar","50"}, 
                                  {"Switch","Int","4"}, 
                                  {"State","Int","4"},
                                  {"LinkList","NText","50000"}
                              };
            return Tablelist;
        }
        ...
        public M_CollectionItem GetModelFromReader(DbDataReader rdr)
        {
