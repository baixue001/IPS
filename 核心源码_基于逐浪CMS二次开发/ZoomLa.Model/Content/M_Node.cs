...
{
    public enum NodeEnum { Root = 0, Node = 1, SPage = 2, OuterLink = 3 };
    public class M_Node : M_Base
    {
        ...
        /// </summary>
        public int NodeListType { get; set; } =1;
        /// <summary>
        /// 节点会员组浏览篇数
        /// </summary>
        ...
        /// 打开方式0原窗口
        /// </summary>
        public bool OpenNew { get; set; } = false;
        /// <summary>
        /// 栏目权限。0--开放栏目  1--认证栏目
        /// </summary>
        ...
        /// 热点的点击数最小值
        /// </summary>
        public int HitsOfHot { get; set; } = 0;
        /// <summary>
        /// 列表页模板
        /// </summary>
        ...
        /// 内容页的文件名规则
        /// </summary>
        public int ContentPageHtmlRule { get; set; } = 3;
        /// <summary>
        /// 列表首页的文件扩展名
        /// </summary>
        public int ListPageHtmlEx { get; set; } = 3;
        /// <summary>
        /// 栏目列表页面扩展名
        /// </summary>
        ...
        /// 最新信息页扩展名
        /// </summary>
        public int LastinfoPageEx { get; set; } = 3;
        /// <summary>
        /// 热门信息页扩展名
        /// </summary>
        public int HotinfoPageEx { get; set; } = 3;
        /// <summary>
        /// 推荐信息扩展名
        /// </summary>
        public int ProposePageEx { get; set; } = 3;
        /// <summary>
        /// 内容页文件扩展名
        /// </summary>
        public int ContentFileEx { get; set; } = 3;
        /// <summary>
        /// 节点目录生成静态位置0-根目录 1-继承父目录结构
        /// </summary>
        public int HtmlPosition { get; set; } = 1;
        /// <summary>
        /// 父节点ID
        /// </summary>
        ...
        /// 替换的打开方式
        /// </summary>
        public string OpenTypeTrue = "_self";
        /// <summary>
        /// URL格式 en,cn
        /// </summary>
