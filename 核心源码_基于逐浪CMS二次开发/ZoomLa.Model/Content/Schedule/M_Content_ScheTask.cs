...
namespace ZoomLa.Model
{
    public class M_Content_ScheTask:M_Base
    {
        ...
        /// 任务JobID
        /// </summary>
        public string TaskFlag { get { return "CTask" + ID; } }
        ...
        {
            get { return ConvertToDate(ExecuteTime); }
        }
        public DateTime LastTime2 { get { return ConvertToDate(LastTime); } }
        /// <summary>
        ...
        {
            ExecuteSQL = 1, Release = 2, Content = 3, CSharp = 4
        };
        ...
        public M_Content_ScheTask GetModelFromReader(DbDataReader rdr) 
        {
