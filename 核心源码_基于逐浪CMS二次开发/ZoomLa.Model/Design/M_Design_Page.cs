...
namespace ZoomLa.Model.Design
{
    public class M_Design_Page : M_Base
    {
        ...
        public override string UP_Tables
        {
            get
            {
                return "ZL_Design_Page,ZL_Design_Scence";
            }
        }
        ...
        public override SqlParameter[] GetParameters()
        {
            ...
            sp[24].Value = model.CUser;
            sp[25].Value = model.AccessPwd;
            return sp;
        }
        public M_Design_Page GetModelFromReader(DbDataReader rdr)
        {
            ...
            model.AccessPwd=ConverToStr(rdr["AccessPwd"]);
            //站点专用
            rdr.Close();
            return model;
        }
