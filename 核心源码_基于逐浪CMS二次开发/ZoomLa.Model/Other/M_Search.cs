...
namespace ZoomLa.Model
{
    ...
    public class M_Search : M_Base
    {
        ...
        /// 0:后台,3:会员
        /// </summary>
        public int LinkState { get; set; } = 0;
        /// <summary>
        /// 用户组ids
        /// </summary>
        ...
        /// 是否推荐：0为不推荐   1为推荐
        /// </summary>
        public int EliteLevel { get; set; } = 1;
        /// <summary>
        /// 排序
        /// </summary>
        ...
        public override string[,] FieldList()
        {
            string[,] Tablelist = {
                                  ...
                                  {"Size","Int","4"},
                                  {"Mobile","Int","4"},
                                  {"UserGroup","NVarChar","4000"},
                                  {"EliteLevel","Int","4"},
                                  {"OrderID","Int","4"},
                                  {"BKColor","NVarChar","100"}
                              };
            return Tablelist;
        }
        public override SqlParameter[] GetParameters()
        {
            ...
            sp[15].Value = model.BKColor;
            return sp;
        }
        public M_Search GetModelFromReader(DbDataReader rdr)
        {
            ...
            model.BKColor = ConverToStr(rdr["BKColor"]);
            rdr.Close();
            return model;
        }
    }
