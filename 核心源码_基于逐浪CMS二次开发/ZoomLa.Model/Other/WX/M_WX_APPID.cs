...
namespace ZoomLa.Model
{
    public class M_WX_APPID:M_Base
    {
        ...
        private string _tbname = "ZL_WX_APPID";
        ...
        public override SqlParameter[] GetParameters()
        {
            ...
            sp[16].Value = model.QRCode;
            return sp;
        }
        public M_WX_APPID GetModelFromReader(DbDataReader rdr)
        {
