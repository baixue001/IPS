...
namespace ZoomLa.Model.Shop
{
    public class M_Order_Repair : M_Base
    {
        ...
        public override SqlParameter[] GetParameters()
        {
            ...
            if (model.TakeTime <= DateTime.MinValue) { model.TakeTime = DateTime.Now; }
            ...
            sp[21].Value = model.AdminRemind;
            sp[22].Value = model.AdminDate;
            return sp;
        }
        public M_Order_Repair GetModelFromReader(DbDataReader rdr)
        {
            ...
            model.AdminDate = ConverToStr(rdr["AdminDate"]);
            rdr.Close();
            return model;
        }
    }
