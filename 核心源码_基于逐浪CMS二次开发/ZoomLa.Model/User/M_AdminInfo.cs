namespace ZoomLa.Model
{
    ...
    public class M_AdminInfo:M_Base
    {
        ...
        /// 管理员ID
        /// </summary>
        public int PubRole { get; set; } = 1;
        public int NodeRole { get; set; } = 0;
        ...
        /// 管理员能否更改密码标识
        /// </summary>
        public bool EnableModifyPassword { get; set; } = true;
        /// <summary>
        /// 管理员是否能重复登录
        /// </summary>
        public bool EnableMultiLogin { get; set; } = true;
        /// <summary>
        /// 管理员是否被锁定
        /// </summary>
        ...
        /// 最近修改密码时间
        /// </summary>
        public DateTime LastModifyPasswordTime { get; set; } = DateTime.Now;
        /// <summary>
        /// 登录次数
        /// </summary>
        ...
        /// 登录随机密码用于验证是否重复登录
        /// </summary>
        public string RandNumber { get; set; }="123456";
        /// <summary>
        /// 内容添加默认权限
        /// </summary>
        public int DefaultStart = 99;
        /// <summary>
        /// 判断是否属于某些角色
        /// </summary>
        ...
        private string ManageNode { get; set; }
        /// <summary>
        /// 管理员类型  1超级管理员
        /// </summary>
        private int AdminType { get; set; }
        /// <summary>
        /// 该管理员账号,绑定的用户ID(暂未启用)
        /// </summary>
        ...
        //---------------------------------------
        public string AdminFace = "/images/UserFace/noface.png";
        public string Mobile = "";
        public string Email = "empty@random.com";
        #endregion
