...
namespace ZoomLa.Model
{
    ...
    public class ZLEnum
    {
        ...
        public enum Auth { model, content, shop, page, exam,extend, user, system, office, portable, sites, other };
        public readonly static string[] AuthModels = new string[] { "model", "content","shop", "page", "exam","extend", "user", "system", "office", "portable", "sites","other" };
        /// <summary>
        /// Withdraw 提现
        /// </summary>
        ...
        //".html|.htm|.shtml|不生成静态"
        public enum Page { Html = 0, Htm = 1, Shtml = 2, 动态页 = 3 }
    }
}
