   ...
   public class EncryHelper
    {
        ...
        private static readonly string DesKey = "seKLDA==";//向量与密钥均使用其
        ...
        private static string aes_defkey = "aeeezoomlaa=tezh";//密钥,16*8=128位
        /// <summary>
        /// AES加密算法
        /// </summary>
        ...
        public static string AESEncrypt(string plainText, string key = "")
        {
            ...
            key = string.IsNullOrEmpty(key) ? aes_defkey : key;
            //分组加密算法
        ...
        public static string AESDecrypt(string cryedText, string key = "")
        {
