...
public class SendWebSMS
{
    ...
    {
        return GetBalance(SMSConfig.Instance.DefaultSMS);
    }
    ...
    public string SendByBJWT(string phone, string msg)
    {
        ...
        string req = this.SendMsg(SMSConfig.Instance.MssUser, SMSConfig.Instance.MssPsw, phone, msg);
    ...
    {
        return GetBJWTBalance(SMSConfig.Instance.MssUser, SMSConfig.Instance.MssPsw);
    }
    ...
    public int SendByEast(string t_sendNo, string t_sendMemo)
    {
        ...
        //string g_uid = SMSConfig.Instance.G_uid;
        //string g_eid = SMSConfig.Instance.G_eid;
        //string g_pwd = SMSConfig.Instance.G_pwd;
        //string g_gate_id = SMSConfig.Instance.G_gate_id;
        ...
        //    if (wsm == null)
        //    {
        //        //Response.Write("<script>alert('网关初始化失败!');window.location='Default';</script>");
        //        return 1;
        //    }
        //    //string strIdentity = wsm.GetIdentityMark(Int32.Parse(g_eid), g_uid, g_pwd, Int32.Parse(g_gate_id));
        //    if (strIdentity == null || strIdentity == "")
        //    {
        //        //Response.Write("<script>alert('获取标识串失败!');window.location='Default';</script>");
        //        return 2;
        //    }
        //    if (t_sendNo.Trim() == "" || t_sendMemo.Trim() == "")
        //    {
        //        //Response.Write("<script>alert('接收号码或者短信内容没有输入!');window.location='Default';</script>");
        //        return 3;
        //    }
        ...
        //    // Response.Write("<script>alert('" + js + "');window.location='MessageInfo';</script>");
        //}
        return 0;
    }
    ...
    {
        return SendByYM(phone, message, SMSConfig.Instance.sms_key, SMSConfig.Instance.sms_pwd);
    }
    ...
    {
        return GetYMBalance(SMSConfig.Instance.sms_key, SMSConfig.Instance.sms_pwd);
    }
    public string GetYMBalance(string sms_key, string sms_pwd) 
    {
        //SDKService client = new SDKService();
