...
namespace ZoomLaCMS.Models.Bar
{
    ...
    public class VM_PClass
    {
        ...
        public VM_PClass(HttpContext ctx,int cpage)
        {
            ...
            if (cateMod == null) { throw new Exception("指定栏目不存在"); }
            #region 权限校验
        ...
        public IHtmlContent CreateCateLi() 
        {
        ...
        public IHtmlContent GetSubTitle(DataRow dr)
        {
        ...
        public IHtmlContent GetTieStaues(DataRow dr)
        {
            ...
            {
                tieimgs += "<span title='版面置顶' class='zi zi_lowvision'></span>";
            }
        ...
        public IHtmlContent GetRUser(DataRow dr)
        {
            string tlp = "<span class='uname' title='回复时间:{0}'><span class='zi zi_commentdots'></span><a href='{1}'>{2}</a>"
