...
namespace ZoomLaCMS.Models.Exam
{
    ...
    public class VM_QuestManage
    {
        ...
        //树形
        string hasChild_tlp = "<li data-pid=@pid data-id=@id><span class='zi zi_pluscircle treeicon'></span><a class='filter_class @type' data-val='@id' href='javascript:;'>@name</a><ul>@childs</ul></li>";
