    ...
    public class VM_Register
    {
        ...
        public string ReturnUrl
        {
            get
            {
                ...
                {
                    string url = HttpUtility.UrlDecode(Request.GetParam("ReturnUrl")).Split(' ')[0];
        ...
        public VM_Register()
        {
            ...
            {
                fieldDT = SqlHelper.ExecuteTable("SELECT *,ModelID=0,IsShow='True',IsSearchForm='False',IsView=1,IsDownField=0 FROM ZL_UserBaseField ORDER BY OrderID ASC");
            ...
            int puid = DataConvert.CLng(Request.GetParam("ParentUserID"));
            string puname = DataConvert.CStr(Request.GetParam("ParentUser"));
