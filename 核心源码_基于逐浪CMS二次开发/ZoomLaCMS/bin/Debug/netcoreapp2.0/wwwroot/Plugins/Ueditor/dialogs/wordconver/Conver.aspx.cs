...
namespace ZoomLaCMS.Plugins.Ueditor.dialogs.wordconver
{
    public partial class Conver : System.Web.UI.Page
    {
        ...
        {
            if (File_UP.PostedFile.ContentLength < 100) { function.Script(this, "alert('请先选择文件');");  }
