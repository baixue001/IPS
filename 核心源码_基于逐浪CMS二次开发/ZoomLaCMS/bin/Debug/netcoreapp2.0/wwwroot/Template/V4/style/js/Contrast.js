...
window.Effect=
{
	...
	HtmlMove:function(id,tag,path,rate,upbt,downbt,pgtime,lis)
	{
		...
		function up(){clearInterval(c);c=setInterval(function(){if(mous){}(o[fx]-rate>0)?(o[fx]-=rate):(o[fx]=mx);},30);}
		function down(){clearInterval(c);c=setInterval(function(){if(mous){}(o[fx]+rate<mx)?(o[fx]+=rate):(o[fx]=0);},30);}
		...
		function go_to(fxs){if(mous){};var ex;
