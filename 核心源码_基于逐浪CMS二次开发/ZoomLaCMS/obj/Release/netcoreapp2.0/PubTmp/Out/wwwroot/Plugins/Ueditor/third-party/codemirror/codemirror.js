...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        function onMouseDown(e) {
            ...
            // selection.
            if (!start) {if (e_target(e) == scroller) e_preventDefault(e); }
        ...
        function onKeyPress(e) {
            if (window.opera && e.keyCode == lastStoppedKey) {lastStoppedKey = null; e_preventDefault(e); }
            if (options.onKeyEvent && options.onKeyEvent(instance, addStop(e))) 
        ...
        function onContextMenu(e) {
            ...
            if (!pos || window.opera)  // Opera is difficult.
