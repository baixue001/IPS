...
(function(mod) {
  ...
  function onDragStart(cm, e) {
    if (ie && (!cm.state.draggingText || +new Date - lastDrop < 100)) { e_stop(e);  }
    if (signalDOMEvent(cm, e) || eventInWidget(cm.display, e)) 
  ...
  function onKeyPress(e) {
    ...
    if (presto && keyCode == lastStoppedKey) {lastStoppedKey = null; e_preventDefault(e); }
  ...
  function onContextMenu(cm, e) {
    ...
    if (!pos || presto)  // Opera is difficult.
