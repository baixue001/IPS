...
adminBtn.hooks["ToOrder"] = function () { window.open(adminBtn.conf.path + "Shop/OrderList"); }
adminBtn.hooks["ToContent"] = function () { window.open(adminBtn.conf.path + "Content/ContentManage"); }
adminBtn.hooks["ToProduct"] = function () { window.open(adminBtn.conf.path + "Shop/ProductManage"); }
//-------------------
