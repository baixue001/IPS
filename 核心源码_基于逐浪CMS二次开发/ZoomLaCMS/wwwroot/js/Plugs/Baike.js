...
info.upRow = function (obj) {
    ...
    if ($tr[0] == $(info.id + " tr:first")[0]) {  }
    $tr.insertBefore($tr.prev());
}
info.downRow = function (obj) {
    var $tr = $(obj).closest("tr");
    if ($tr[0] == $(info.id+" tr:last")[0]) {  }
...
refence.editTlp = "<div class=\"ref_item\"><div>"
            ...
            + "<a onclick=\"refence.showEdit('@id');\"><i class=\"zi zi_pencilalt\"></i>编辑</a> "
            + "<a onclick=\"refence.del('@id');\"><i class=\"zi zi_remove\"></i>删除</a>"
            + "</div></div>"
            + "<div class=\"item_url_div\"><a href=\"@url\" class=\"item_url\" target=\"_blank\">@url</a></div>"
            + "</div>";
refence.htmlTlp = "<div class=\"ref_item\">"
    + "@oid.<a href=\"@url\" class=\"item_url\" target=\"_blank\">@name <i class=\"zi zi_sharealt\" style=\"color:#136ec2;\"></i></a>"
